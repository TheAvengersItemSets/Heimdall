...
public class PayOrderServiceClient {
    ...
    public String createPayOrder(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/create?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String queryPayOrder(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/query?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doWxPayReq(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/wx?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doAliPayWapReq(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/ali_wap?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doAliPayPcReq(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/ali_pc?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doAliPayMobileReq(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/ali_mobile?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doAliPayQrReq(String jsonParam) {
        return restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/ali_qr?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
    }
    ...
    public String doFuYouPayQrReq(String jsonParam) {
        String result = restTemplate.getForEntity("http://HEIMDALL-SERVICE/pay/channel/fuyou_wap?jsonParam=" + MyBase64.encode(jsonParam.getBytes()), String.class).getBody();
        return result;
    }
