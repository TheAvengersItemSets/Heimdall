package org.heimdall.shop.demo;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import org.heimdall.common.util.PayDigestUtil;
...
public class PayOrderDemo {
    ...
    static final String notifyUrl = "http://127.0.0.1:8092/goods/payNotify";
    ...
    static String payOrderTest() {
        ...
        paramMap.put("channelId", "FUYOU_ONLINE");
        ...
        paramMap.put("extra", "{\n" +
                ...
                "    }\n" +
                "  }\n" +
                " ,\"discountable_amount\":\"0.01\"," + //面对面支付扫码参数：可打折金额 可打折金额+不可打折金额=总金额
                "  \"undiscountable_amount\":\"0.02\"," + //面对面支付扫码参数：不可打折金额
                "}");  // 附加参数
