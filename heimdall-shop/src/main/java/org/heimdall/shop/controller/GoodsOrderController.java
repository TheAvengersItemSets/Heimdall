package org.heimdall.shop.controller;
...
import org.heimdall.shop.dao.model.GoodsOrder;
import org.heimdall.shop.service.GoodsOrderService;
import org.heimdall.shop.util.Constant;
import org.heimdall.shop.util.OAuth2RequestParamHelper;
import org.heimdall.shop.util.vx.WxApi;
import org.heimdall.shop.util.vx.WxApiClient;
...
public class GoodsOrderController {
    ...
    static final String mchId = "2016101600703317";
    // 加签key
    ...
    void outResult(HttpServletResponse response, String content) {
        ...
        try {
            ...
            pw.print(content);
            _log.error("response heimdall complete.");
        } catch (IOException e) {
            _log.error(e, "response heimdall write exception.");
        }
    }
